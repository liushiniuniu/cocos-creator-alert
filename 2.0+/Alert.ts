...
export default class Alert  {
    ...
    private static _initDefaultTitle(){
        ...
        ctx.rect(-titleArea.width/2, -titleArea.height/2, titleArea.width, titleArea.height)
    ...
    private static _initDefaultBody(){
        ...
        ctx.rect(-bodyArea.width/2, -bodyArea.height/2, bodyArea.width, bodyArea.height)
    ...
    private static _initDefaultFoot(){
        ...
        ctx.rect(-footArea.width/2, -footArea.height/2, footArea.width, footArea.height);
    ...
    private static _initDefaultPanel(){
        ...
        ctx.roundRect(-this.box.width/2,  - this.box.height/2,this.DEFAULT_WIDTH, this.DEFAULT_HEIGHT, this.DEFAULT_RADIUS);
        ctx.stroke();
        ctx.fillColor = this.PANEL_COLOR;
        ctx.fill();
    ...
    private static setBodyMessage(messagae: string){
        cc.find('panel/bodyArea/bodyText', this.bgLayer).getComponent(cc.Label).string = messagae;
    }
}
